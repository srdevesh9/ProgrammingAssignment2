## this function is created to accept a matrix and inverse it and pass that to another class if inverse does not exist then inverse else load the result from cache
